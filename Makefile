...
#    Updated: 2024/01/17 13:32:25 by ade-beco         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_PATH	=		./src/
SRCS 		=		push_swap.c stacks_utils.c sort_operations.c
SRCS_D 		=		$(SRC_PATH)push_swap.c $(SRC_PATH)stacks_utils.c $(SRC_PATH)sort_operations.c
